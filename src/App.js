...
import GoldBuy from "./screens/App/Inbox";
import GoldSell from "./screens/App/Chat";
import GoldDilver from "./screens/App/Calendar";
import appContact from "./screens/App/Contact";
import appTaskbar from "./screens/App/Taskbar";
import SilverBuy from "./screens/FileManager/Dashboard";
import SilverSell from "./screens/FileManager/Documents";
import SilverDilver from "./screens/FileManager/Media";
...
import basicelements from "./screens/FileManager/BasicElements";
...
import silverSummary from "./screens/FileManager/silverSummary";
    ...
    return (
      <div id="wrapper">
        {activeKey1 === "" ||
          ...
          <>
            {activeKey1 != 'dashboard' ? (
              <NavbarMenu history={this.props.history} activeKey={activeKey1} />) : null}
            <div id="main-content" >
              <Switch>
                <Route
                  exact
                ...
                <Route
                  exact
                  path={`${process.env.PUBLIC_URL}/GoldBuy`}
                  component={GoldBuy}
                />
                <Route
                  exact
                  path={`${process.env.PUBLIC_URL}/GoldSell`}
                  component={GoldSell}
                />
                <Route
                  exact
                  path={`${process.env.PUBLIC_URL}/GoldDilver`}
                  component={GoldDilver}
                />
                <Route
                  exact
                ...
                <Route
                  exact
                  path={`${process.env.PUBLIC_URL}/SilverBuy`}
                  component={SilverBuy}
                />
                <Route
                  exact
                  path={`${process.env.PUBLIC_URL}/SilverSell`}
                  component={SilverSell}
                />
                <Route
                  exact
                  path={`${process.env.PUBLIC_URL}/SilverDilver`}
                  component={SilverDilver}
                />
                <Route
                  exact
                ...
                <Route
                  exact
                  path={`${process.env.PUBLIC_URL}/silversummary`}
                  component={silverSummary}
                />
                <Route
                  exact
