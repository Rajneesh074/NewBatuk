...
const AppTaskbar = (props, location) => {
  ...
  console.log("taskbar token", token);
  ...
  const callCityAPI = async () => {
    try {
      const url = "http://13.201.77.26:1337/stateCode/getcity";
      const headers = {
        "Content-Type": "application/json",
        "Accept": "application/json",
        "Authorization": `Bearer ${token} `,
  ...
  const handleDobChange = (event) => {
    setpandob(event.target.value);
  }

  const handleEmailChange = (event) => {
    setpanemail(event.target.value);
  }
  ...
  // console.log("pan number", storedPanNumber);
  // if (storedPanNumber) {
  //   handlePayment();
  // } else {
  ...
  const handlePanPopupConfirm = async () => {
    try {
      ...
      const url = "http://13.201.77.26:1337/kyc/pan"; // Replace with your API endpoint
      const headers = {
        "Content-Type": "application/json",
      ...
      setShowKycPopup(false); // Show the second pop-up or perform any other actions as needed
    } catch (error) {
      console.error("Error connecting to API", error);
    }
  };
  ...
  const pangetApi = async () => {
    try {
      const url = "http://13.201.77.26:1337/kyc/getDetails";
      const headers = {
        "Content-Type": "application/json",
        "Accept": "application/json",
        "Authorization": `Bearer ${token} `,
      ...
      let storedPanNumber = data.data[0].pan.msg
      const p = storedPanNumber != null ? storedPanNumber.PanNumber : "";
      console.log("main data", p);
  ...
  const handleSecondPopupClose = () => {
    ...
    // Navigate to "/appinbox" when the second pop-up is closed
    // history.push("/GoldBuy");
            ...
            <div className="col-md-7 bg-white p-3">
              ...
              <div className="d-flex justify-contact-center p-2" style={{ borderBottom: "2px solid black" }}>
                ...
                <div className="col-md-5 " >
                  ...
                  <h5 className="text-dark h6">Gold Weight: {Gweight} gm</h5>
                </div>
              </div>
              <div className="details" style={{ color: "black" }}>
                ...
                <table class="table h6">
                  ...
                  <tbody>
                    <tr>
                      <td scope="col">Rate Of Gold Per Gm</td>
          ...
          <Modal.Body>
            ...
            <form className="form-group" style={{ fontSize: "20px" }}>
              <div className="row mb-3 p-2">
                ...
                <input type="text" className="form-control outline-none" id="PanInput" placeholder="Enter PAN no" style={{ border: "2px solid #eed881" }} onChange={handlePanChange} name="PanNumber" />
                <p style={{ color: "red", fontSize: "14px", marginTop: "5px" }}>{panValidationMessage}</p>
              </div>
              <div className="row mb-3 p-2">
                <label for="exampleInputEmail1">DOB</label>
                <input type="date" className="form-control outline-none" id="exampleInputEmail1" placeholder="Enter your address" style={{ border: "2px solid #eed881" }} name="dob" onChange={handleDobChange} />
              </div>
              <div className="row mb-3 p-2">
                <label for="exampleInputEmail1">Email</label>
                <input type="email" className="form-control outline-none" id="exampleInputEmail1" placeholder="Enter your email" style={{ border: "2px solid #eed881" }} name="email" onChange={handleEmailChange} />
              </div>
            </form>
