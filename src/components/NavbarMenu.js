      ...
      <div>
        ...
        <div id="left-sidebar" className="sidebar" style={{ zIndex: 9 }} >
          <div className="sidebar-scroll">
            {/* <div className="user-account bg-info">
              <img
                src={UserImage}
                className="rounded-circle user-photo"
                alt="User Profile Picture"
                ...
                <ul id="main-menu" className="metismenu">
                  <li className="" id="dashboradContainer">
                    ...
                    >
                      ...
                      <Link to="dashboard" className="ml-4" style={{ fontSize: "18px" }}>DashBoard</Link>
                  ...
                  <li id="AppContainer" className="">
                    ...
                    >
                      <i className="icon-grid"></i> <span>GOLDIFY</span>
                    </a>
                    <ul className="collapse">
                      <li
                        className={activeKey === "GoldBuy" ? "active" : ""}
                        onClick={() => { }}
                      >
                        <Link to="GoldBuy">Buy Gold</Link>
                      </li>
                      <li
                        className={activeKey === "GoldSell" ? "active" : ""}
                        onClick={() => { }}
                      >
                        <Link to="GoldSell">Sell Gold</Link>
                      </li>
                      <li
                        className={
                          activeKey === "GoldDilver" ? "active" : ""
                        }
                        onClick={() => { }}
                      >
                        <Link to="GoldDilver">Delivery Gold</Link>
                      </li>
                      {/* <li
                  ...
                  <li id="FileManagerContainer" className="">
                    ...
                    <ul className="collapse">
                      <li
                        className={
                          activeKey === "SilverBuy" ? "active" : ""
                        }
                        onClick={() => { }}
                      >
                        <Link to="SilverBuy">Buy Silver</Link>
                      </li>
                      <li
                        className={
                          activeKey === "SilverSell" ? "active" : ""
                        }
                        onClick={() => { }}
                      >
                        <Link to="SilverSell">Sell Silver</Link>
                      </li>
                      <li
                        className={activeKey === "SilverDilver" ? "active" : ""}
                        onClick={() => { }}
                      >
                        <Link to="SilverDilver">Delivery Silver</Link>
                      </li>
                      {/* <li
                  ...
                  <li id="BlogContainer" className="">
                    ...
                    >
                      <i className="icon-globe"></i> <span>GAINIFY</span>
                    </a>
                    <ul className="collapse">
                      {/* <li
                        className={
                  ...
                  <li id="WidgetsContainer" className="">
                    ...
                    >
                      <i className="icon-puzzle"></i> <span>WILLIFY</span>
                    </a>
                    <ul className="collapse">
                      {/* <li
                        className={
